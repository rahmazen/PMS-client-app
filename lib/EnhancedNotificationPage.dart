...
import 'SignIn.dart';
import 'websocket/Notifications.dart';
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  onPressed: () {
                    // Use the websocket service to mark all as read
                    widget.webSocketService.markAllAsRead(type);
                  },
                  child: Text(
                    "Mark all as read",
                    style: TextStyle(
        ...
        return NotificationCard(
          ...
          isComment: type == 'room',
          onTap: () {
            widget.webSocketService.markAsRead(notification.id);
          },
        );
      },
    );
